...
def expand_universe(stars_list, expansion_rate=1):
    max_x = 0
    max_y = 0
...
def solve(grid, expansion_rate):
    ...
    expanded = expand_universe(stars, expansion_rate)
...
def main():
    test_1 = solve(test_input_1, 10)
    print('test_1:', test_1)

    test_2 = solve(test_input_1, 100)
    print('test_1:', test_2)

    start = time()
    answer = solve(input_data, 1_000_000)
    print('answer:', answer)
