...
def solve(seed):
    ...
    for i in range(128):
        ...
        hashtable = []
        for char in partial_hash:
            hashtable.append(int(char))
        solution.append(hashtable)

    # label and count distinctive regions
    regions, regions_count = scipy.ndimage.label(solution)

    # SciPy feels like cheating, but "Image recognition and analysis" course from my B.Eng. came in handy eventually...
